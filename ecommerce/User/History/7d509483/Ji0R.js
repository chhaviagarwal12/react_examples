...
return(
    <div ref={ref}>
        ...
        <Link to='/userprofile' className='menu-item'>{window.localStorage.getItem("token")?{`(userProfile.name.firstname)+" "+(userProfile.name.lastname)`}:"User Profile"}  <i className="user large icon">
                </i></Link>
        <hr/>
