...
const ProductDescription=({show,handleModalState,productDescription,addCart,increaseQty})=>{
// console.log("From modal",productDescription)
 ...
 const setItem=useContext(SelectedProductContext)
  ...
  const mapDispatchToProps=(dispatch,ownProps)=>{
   ...
   return{
    addCart:dispatch(addToCart(ownProps.productDescription)),
    increaseQty:dispatch(increaseQty(ownProps.productDescription,1))
   }
}
