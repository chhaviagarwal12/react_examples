...
const Navigation=()=>{
    ...
    const setProductDescription=(productDescription)=>{
        ...
        setWishlistedItem([productDescription.image,productDescription.title])
        console.log("from navigation component",wishlistedItem)
}
  ...
  const setCategoryCallback=(category)=>{
    ...
    return(
        <div>
            ...
            <Route path="/wishlist"  element={<Wishlist image={image} title={productName}/>}></Route>
