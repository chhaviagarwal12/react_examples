...
const mapDispatchToProps=(dispatch,ownProps)=>{
    ...
    for(const keys in ownProps.selectedProduct){
        console.log("type of",typeof(ownProps.selectedProduct.keys))
        // if(ownProps.selectedProduct.key==="id"){
        //     // ownProps.qty+=1
        //     console.log("ownProps:",ownProps.selectedProduct[key])
        // }
       
    }
   return{
   setQty:dispatch(increaseQty(ownProps.qty))
   }
}
