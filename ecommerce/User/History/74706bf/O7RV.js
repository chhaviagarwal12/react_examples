...
//    console.log("in main menu component")
    // useEffect(()=>{
    ...
    return(
        <>
            ...
            {(token)?
                ( <div onClick={setToken(null)}><i className="log out large icon"/>LOGOUT</div>)
                : ( <div onClick={setToken(props.loginResponse)}><i className="sign in large icon"/>LOGIN</div>)}
            </NavLink>
