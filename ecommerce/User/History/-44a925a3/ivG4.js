...
import { userLogin,getCartDetails } from "../../actions";
           ...
           <div className="ui pink segment" >
            <div className="ui form">
               ...
               <Button ref={ref} type="submit" color="pink"  onClick={(event)=>{
                  handleSubmit(event)
                  userLoginRequest()
                  props.getCartDetails(window.localStorage.getItem("id"))}}>SUBMIT</Button>
...
export default connect(null,{userDetails,userLogin,getCartDetails})(UserLogin)