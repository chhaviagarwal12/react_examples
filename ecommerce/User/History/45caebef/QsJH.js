...
export const addToCart=(selectedProduct)=>(dispatch)=>{
...
export const increaseQty=(id,qty)=>(dispatch)=>{
    console.log("increase quantity action ",qty)
    dispatch({
        type:"INCREASE_QTY",
        payload:[id,qty]
    })
...
export const decreaseQty=(id,qty)=>{
    console.log("DECREASE quantity action ",qty)
    return{
        type:"DECREASE_QTY",
        payload:[id,qty]
    }
